...
const Hero = () => {
  return (
    <div className="flex h-screen flex-col items-start justify-center bg-[url('/src/assets/heroImage.jpg')] bg-cover bg-center bg-no-repeat px-6 text-white md:px-16 lg:px-24 xl:px-32">
